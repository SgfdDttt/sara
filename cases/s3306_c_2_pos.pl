% Text
% Alice has paid wages of $300 to Bob for work done from Feb 1st, 2017 to Sep 2nd, 2017, in Baltimore, Maryland, USA for domestic service in her home.
...
s3306_b(300,alice_pays,alice_employer,alice,bob,_,_,_,_,alice,bob)
