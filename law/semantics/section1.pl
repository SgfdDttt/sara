%§1. Tax imposed
s1(Individual,Year,Tax_amount) :-
    s1_a(Individual,Year,Tax_amount);
    s1_b(Individual,Year,Tax_amount);
    s1_c(Individual,Year,Tax_amount);
    s1_d(Individual,Year,Tax_amount).

%(a) Married individuals filing joint returns and surviving spouses
s1_a(Individual,Year,Tax_amount) :-
    (
        s1_a_1(Individual,Year,Tax_amount);
        s1_a_2(Individual,Year,Tax_amount)
    ).
...
s1_a_1(Individual,Year,Tax_amount) :-
    ...
    s1_a_tax(Taxable_income,Tax_amount).
...
s1_a_i(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(Taxable_income*0.15).
...
s1_a_ii(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(5535+(Taxable_income-36900)*0.28).
...
s1_a_iii(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(20165+(Taxable_income-89150)*0.31).
...
s1_a_iv(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(35928.50+(Taxable_income-140000)*0.36).
%(v) $75,528.50, plus 39.6% of the excess over $250,000 if the taxable income is over $250,000.
s1_a_v(Taxable_income,Tax_amount) :-
    250000 < Taxable_income,
    Tax_amount is round(75528.50+(Taxable_income-250000)*0.396).
...
s1_b_ii(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(4440+(Taxable_income-29600)*0.28).
...
s1_b_iii(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(17544+(Taxable_income-76400)*0.31).
...
s1_b_iv(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(33385+(Taxable_income-127500)*0.36).
%(v) $77,485, plus 39.6% of the excess over $250,000 if the taxable income is over $250,000.
s1_b_v(Taxable_income,Tax_amount) :-
    250000 < Taxable_income,
    Tax_amount is round(77485+(Taxable_income-250000)*0.396).
...
s1_c_ii(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(3315+(Taxable_income-22100)*0.28).
...
s1_c_iii(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(12107+(Taxable_income-53500)*0.31).
...
s1_c_iv(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(31172+(Taxable_income-115000)*0.36).
%(v) $79,772, plus 39.6% of the excess over $250,000 if the taxable income is over $250,000.
s1_c_v(Taxable_income,Tax_amount) :-
    250000 < Taxable_income,
    Tax_amount is round(79772+(Taxable_income-250000)*0.396).
...
s1_d_ii(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(2767.50+(Taxable_income-18450)*0.28).
...
s1_d_iii(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(10082.50+(Taxable_income-44575)*0.31).
...
s1_d_iv(Taxable_income,Tax_amount) :-
    ...
    Tax_amount is round(17964.25+(Taxable_income-70000)*0.36).
%(v) $37,764.25, plus 39.6% of the excess over $125,000 if the taxable income is over $125,000
s1_d_v(Taxable_income,Tax_amount) :-
    125000 < Taxable_income,
    Tax_amount is round(37764.25+(Taxable_income-125000)*0.396).
